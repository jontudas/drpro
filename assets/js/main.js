...
function sliderActive() {
	...
	if (jQuery(".testimonial-slider-active").length > 0) {
	  ...
	  var swiper = new Swiper(".karx-testimonial-2-acive", {
        cssMode: true,
		infinite: true,
		loop: true,
        navigation: {
	  ...
	  const slider_thumb = new Swiper('.karx_testimonial_thumbs_active', {
		loop: true,
		spaceBetween: 0,
		slidesPerView: 3,
		rtl: false,
	...
	const slider3 = new Swiper('.karx_testimonial_message_active', {
		loop: true,
		spaceBetween: 0,
		rtl: false,
		slidesPerView: 1,
